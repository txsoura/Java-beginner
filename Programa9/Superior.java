 ...
 * @author Victor
 */
public class Superior implements Calculo {
    ...
    public Superior(String nome, byte cursos, float despesas) {
        this.nome = nome;
        this.cursos = cursos;
    ...
    public String toString() {
        return "Superior{" + "Nome=" + nome + ", Numero de cursos=" + cursos + ", Valor gasto com o ensino=" + mt.format(valorTotal()) + '}';
    }
}
